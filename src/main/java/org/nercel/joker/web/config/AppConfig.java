...
*/  
@Configuration
@ComponentScan(basePackages = "org.nercel.joker.web", excludeFilters = { @ComponentScan.Filter(type = FilterType.ANNOTATION, value = { Controller.class }) })
@EnableAspectJAutoProxy(proxyTargetClass=true)
//@ImportResource({ "classpath:config/context/applicationContext-hibernate4.xml" })
@Import({CachingConfig.class,HibernateConfig.class})
